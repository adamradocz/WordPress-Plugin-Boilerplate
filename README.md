...
* Contatains templates for [Admin menu](https://codex.wordpress.org/Adding_Administration_Menus), [Settings](https://codex.wordpress.org/Settings_API), [Shortcode](https://codex.wordpress.org/Shortcode_API) and Form.
